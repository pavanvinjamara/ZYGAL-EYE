...
function validate() {
  if (!vendor.value) return "Please select your company.";
  ...
  <div class="w-screen h-screen flex flex-col justify-center overflow-hidden relative bg-[var(--login-from)]">
    ...
    <div class="relative z-10 w-[420px] mx-auto rounded-2xl p-10 bg-[var(--card)] shadow-[0_25px_60px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,255,255,0.1)]">
      ...
      <div class="text-center mb-8">
        <div class="flex items-center justify-center gap-3 mb-5">
          ...
          <div class="text-left">
            ...
            <div class="text-[10px] uppercase tracking-wider text-[var(--text-muted)] mt-0.5">Vendor Portal</div>
          </div>
        </div>
        <div class="text-xl font-bold text-[var(--text)] mb-1">Vendor Sign In</div>
        <div class="text-[13px] text-[var(--text-muted)]">Access your tickets, SLA data &amp; penalty reports</div>
      </div>
      ...
      <div class="text-center text-[11px] leading-relaxed text-[var(--text-muted)]">
        Trouble signing in? Contact your IIFL EYE administrator<br>
